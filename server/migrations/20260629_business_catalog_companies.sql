...
CREATE TABLE IF NOT EXISTS companies (
  ...
  license_url VARCHAR(500) DEFAULT '',
  verification_status ENUM('unverified', 'pending', 'verified', 'rejected') NOT NULL DEFAULT 'unverified',
  paid_display_status ENUM('none', 'active', 'expired', 'suspended') NOT NULL DEFAULT 'none',
  paid_display_starts_at DATETIME DEFAULT NULL,
  paid_display_ends_at DATETIME DEFAULT NULL,
