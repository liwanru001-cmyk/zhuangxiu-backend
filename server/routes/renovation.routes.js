...
router.put('/projects/:id/presentation-documents/:documentId/title',
  ...protectedRoute, asyncHandler(presentationDocuments.rename));
...
router.post(
  '/projects/:id/design-documents/:documentId/delete-request',
  ...protectedRoute,
  asyncHandler(controller.createProjectDesignDocumentDeleteRequest)
);
router.put(
  '/projects/:id/design-documents/:documentId/delete-request/:requestId/review',
  ...protectedRoute,
  asyncHandler(controller.reviewProjectDesignDocumentDeleteRequest)
);
router.put(
...
router.put(
  '/projects/:id/spaces/:spaceId/design-description',
  ...protectedRoute,
  asyncHandler(controller.updateProjectSpaceDesignDescription)
);
router.delete(
  '/projects/:id/spaces/:spaceId',
  ...protectedRoute,
