...
router.get('/profile-resume', asyncHandler(auth), asyncHandler(userController.getPublicProfileResume));
router.put('/profile-resume', asyncHandler(auth), asyncHandler(userController.updatePublicProfileResume));
