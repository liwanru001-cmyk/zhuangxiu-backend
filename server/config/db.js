...
async function ensureAppTables() {
  ...
  await ensureProjectProgressChangeRequestTables();
  ...
  await ensureProjectContentShareTables();
...
async function ensureProjectProgressChangeRequestTables() {
  await pool.query(`
...
async function ensureProjectContentShareTables() {
  await pool.query(`
