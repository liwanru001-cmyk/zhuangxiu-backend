...
async function runClaimed(deps = {}) {
  ...
  try {
    ...
    if (context) {
      const messages = { repair_failed: 'V2 排版校验未通过，本次未生成 PPT，也未退回 V1。请提供任务 ID 排查。', design_invalid: 'V2 返回的设计结构未通过校验，本次未退回 V1。请提供任务 ID 排查。', repair_content_changed: 'V2 排版修正改变了文案，已停止生成，本次未退回 V1。请提供任务 ID 排查。', model_outcome_unknown_after_restart: '模型生成期间服务发生切换，旧请求结果无法确认。系统未重复调用模型，请点击重试创建新任务。', asset_unavailable: '项目素材无法读取，请检查文件后重新生成。', asset_mapping_error: '项目素材关联异常，请联系管理员检查。', asset_task_budget: '所选图片总量过大，请减少素材后重新生成。', font_environment: '生成环境的字体尚未配置完成，请联系管理员。', font_render_environment: '生成环境的中文字体不可用，请联系管理员。', render_environment: '生成环境尚未准备完成，请联系管理员。' };
